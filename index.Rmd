...
A special thanks goes to all those that edited the book via GitHub pull requests: Huang Qiang (`nickyfoto`), Marc-André Désautels (`desautm`), Michail Schwab (`michaschwab`) and Alvaro Larreategui (`alvarolarreategui`).
