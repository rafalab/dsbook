...
subtitle: "Real-World Data Analysis and Prediction Algorithms with R"
...
The R markdown code to generate the notes is available on  [GitHub](https://github.com/rafalab/dsbook).
...
A special thanks goes to all those that edited the book via GitHub pull requests: Huang Qiang (`nickyfoto`), Marc-André Désautels (`desautm`), Michail Schwab (`michaschwab`), Alvaro Larreategui (`alvarolarreategui`), Jake VanCampen (`jakevc`), Guillermo Lengemann (`omerta`), and Amy Gill (`gillsignals`).
