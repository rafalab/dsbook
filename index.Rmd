...
This the website for the first edition of Introduction to Data Science. **This book is now out-of-date**. We recommend using the second edition which is now divided in two parts:

* [Introduction to Data Science](https://rafalab.github.io/dsbook-part-1/), Data Wrangling and Visualization with R.
...
`med-hat` (Medhat Khalil), `kengustafson`, `Yowza63`, `ryan-heslin` (Ryan Heslin), `raffaem`, `tim8west`, `lgatto` (Laurent Gatto), `jooleer`, `pauluhn` (Paul), David D. Kane, El Mustapha El Abbassi, Vadim Zipunnikov, Anna Quaglieri, Chris Dong, Bowen Gu, and Rick Schoenberg.
