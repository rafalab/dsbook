...
These are the class notes used in the
 [HarvardX Data Science Series](https://www.edx.org/course/data-science-r-basics-harvardx-ph125-1x). The code to generate the notes are available on  [GitHub](https://github.com/rafalab/dsbook).
