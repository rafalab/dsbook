...
Once we see how statistical inference is applied in the real world, we will introduce _regression_, a technique that is useful to describe the relationship between two or more variables. We will describe how this technique was used to build a baseball team with a limited budget by finding new insights by examining the relationship between player statistics and runs (points). 

The concepts covered in this part, Probability, Statistical Inference and Regression, are three major topics covered in a Statistics Course. We introduce these these concepts briefly and then focus on describing how they are used to answer real-world questions. For a in-depth presentation of these topics we highly recommend supplementing this part with a Probability and Statistics text book.
