...
Most of the examples will come from the second case study which deals with self reported heights by students and most of the chapter is dedicated to learning regular expressions and functions in the __lubridate__ package.
...
Finally, note that in this table we mention _groups_. These will be explained later, in Section \@ref(groups)
...
new_research_funding_rates %>% tbl_df()
```
