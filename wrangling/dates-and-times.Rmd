...
Lubridate is also useful for dealing with times. In R, you can get the current time typing `Sys.time()`. Lubridate provides a slightly more advanced function, `now`, that permits you to define the time zone:
