...
Another useful set of functions are the _parsers_ that converts strings into dates. The function `ymd` assumes the dates are in the format YYYY-MM-DD and tries to parse as best as possible.
