...
The `dplyr` function _bind_cols_ binds two objects by making them columns in a table. For example, we quickly want to make a data frame consisting of numbers we can use.
