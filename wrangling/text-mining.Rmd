...
If we are interested in exploring which specific words are driving these differences, we can [AN: "refer"?] back to our `android_iphone_or` object:
...
This is just a simple example of the many analyses one can [AN: insert "perform"?] before with tidytext.
