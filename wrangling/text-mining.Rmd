...
The first step in sentiment analysis is to assign a sentiment to each word. As we demonstreate, the __tidytext__ package includes several maps or lexicons. Other we will obtain using __textdata__ package.
