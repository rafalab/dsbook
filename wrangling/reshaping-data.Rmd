...
Now that the data is tidy, we can use relatively simple ggplot code:
...
We can achieve the same final result by uniting the second and third columns, then spreading the columns and renaming `fertlity_NA` to `fertility`:
