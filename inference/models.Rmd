...
In this section we will introduce ideas behind the _statistical models_, also known as _probability models_, that were used by Fivethirtyeight, and other poll aggregotors, to improve the election forecasts power of individual polls. In this chapter we motivet the models. These models are written out mathamatically in Section \@ref(election-forecasting).
...
### A data driven model {#data-driven-model}
