...
$$ 
    with $A = \mbox{two of her children are found dead with no evidence of physical harm}$ and $B=\mbox{a mother is a son-murdering psychopath} ) = 0.50$. Assume that the rate of son-murdering psychopaths mothers is 1 in 1,000,000.     According to Bayes' rule,
