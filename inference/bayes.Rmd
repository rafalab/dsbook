...
```{r batting-averages-histogram, fig.cap="Batting average histograms for 2010, 2011, and 2012.", echo=FALSE,fig.width=10.5,fig.height=5.25,message=FALSE}
library(Lahman)
...
$$ 
    with $A = \mbox{two of her children are found dead with no evidence of physical harm}$ and $B=\mbox{a mother is a son-murdering psychopath} ) = 0.50$. Assume that the rate of rate of son-murdering psychopaths mothers is 1 in 1,000,000.     According to Bayes' rule,
what is the probability of $\mbox{Pr}(B \mid A)$ ?
