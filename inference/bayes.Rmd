...
```{r batting-averages-histogram, echo=FALSE, out.width="100%", fig.height=5, message=FALSE}
library(Lahman)
...
So is José lucky or is he the best batter seen in the last 50 years? Perhaps it's a combination of both luck and taent. But how much of each? If we become convinced that he is lucky, we should trade him to a team that trusts the .450 observation and is maybe overestimating his potential.
