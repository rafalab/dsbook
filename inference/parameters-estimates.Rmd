...
The theory we just learned about the sum of draws becomes useful because if we that the distribution of the average $\bar{X}$ because $N$ is a non-random constant. --> This sentence needs reworking.
