...
--> Can the author please elaborate on the assumptions we take? We already assumed independence and that the sample is drawn with replacement. A simple explanation of what would be the complexity if we didn't make those assumptions would be nice.
