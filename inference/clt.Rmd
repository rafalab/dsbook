...
How does this help us? Suppose we want to know what is the probability that we are within 1% from $p$. We are basically asking if:
...
$$
In statistics textbooks, a little hat denotes estimates. The estimate can be constructed using the observed data and $N$. 
...
We multiply by 2 because if we ask what is the probability that we are within two standard errors from $p$, we get:
