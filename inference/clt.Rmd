...
2. Now assume `p <- 0.45` and that your sample size is $N=100$. Take a sample of $N$ observations, repeat that 10,000 times and save the vector of `mean(X)- p` into an object called `errors`. Hint: use the function you wrote for exercise 1 to write this in one line of code.
