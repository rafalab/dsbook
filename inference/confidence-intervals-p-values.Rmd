...
```{r first-confidence-intervals-example, message=FALSE, echo=FALSE}
data("nhtemp")
...
Pollsters are not successful by providing correct confidence intervals, but rather at predicting who will win. When we took a 25 bead sample size, the confidence interval for the spread:
