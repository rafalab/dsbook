...
We know that, by definition, HR cause runs because. [AN: previous sentence incomplete] It could be that HRs also cause BB and this makes it appear as if BB cause runs. This is called confounding, an important concept we will learn more about.

Linear regression will help us parse all this out and quantify the associations. This will then help us determine what players to recruit. Specifically, we will try to predict things like how many more runs will a team score if we increase the number of BBs, but keep the HRs fixed? Regression will help us answer this question.



## Regression applied to baseball statistics

Can we use regression with these data? First, notice that the Home Run and Run data appear to be bivariate normal:
