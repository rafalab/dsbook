...
In the exercises, we will look at other relatioships. 
...
When interpreting correlations, keep in mind that correlations derived from samples are estimates containing uncertainty.
