...
```{r boxplot-1, fig.height = 4, fig.width = 4}
...
```{r boxplot-2, fig.height = 4, fig.width = 4}
galton_heights %>% 
...
```{r conditional-averages-follow-line, echo=FALSE, fig.height = 4, fig.width = 4}
r <- galton_heights %>% 
  summarize(r = cor(father, son)) %>% 
  pull(r)
...
```{r regression-line, fig.height = 4, fig.width = 4, fig.height = 4, fig.width = 4}
...
```{r regression-line-standard-units, fig.height = 4, fig.width = 4} 
galton_heights %>% 
...
```{r two-regression-lines, fig.height = 4, fig.width = 4}
galton_heights %>% 
  ggplot(aes(father, son)) + 
  geom_point(alpha = 0.5) + 
