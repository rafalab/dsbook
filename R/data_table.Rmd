...
`y` is actually referencing `x`, it is not an new object: it's just another name for `x`. Until you change `y`, a new object will not be made. However, the `:=` function changes _by reference_ so if you change `x`, a new object is not made and `y` continues to be just another name for `x`:
