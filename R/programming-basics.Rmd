...
One advantage that becomes clear later is that with the __purrr__ functionals you know what type of object you will get back. This is different with `sapply` which can return several different types. The `map` function always returns a list. 
