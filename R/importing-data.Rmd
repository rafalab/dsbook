...
```{r, eval=FALSE}
tmp <-"url <- \"https://raw.githubusercontent.com/rafalab/dslabs/master/inst/extdata/murders.csv\""
cat(substr(tmp, 1, options()$width))
cat(substr(tmp, options()$width+1, nchar(tmp)))
```
