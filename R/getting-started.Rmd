...
In this chapter we provide a very brief description on how to install R and RStudion. However, note that this book includes an entire part dedicated to data science software tools titled  _Productivity Tools_. Those wanting more details can skip ahead to that part. Here we briefly describe the basics of the installation process.
...
[here](http://www.rstudio.com/products/rstudio/download/). Special instructions for Windows users are [here](https://github.com/genomicsclass/windows).
...
If you are going to follow along with RStudio as you read this book, you might consider reading the chapter five sections specifically dedicated to RStudio. Besides a script editor, RStudio includes many useful features and you want to familiarize yourself with these.
