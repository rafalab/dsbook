...
In this chapter we provide a very brief description on how to install R and RStudion. However, note that have an entire part of the book dedicated to data science software tools titled  _Productivity Tools_. Those wanting more details can skip ahead to that part.
