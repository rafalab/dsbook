...
But be careful not to cofuse the single quote ' with the _back quote_ `. 
...
When we use these function, R produces integers, not numerics, because they are typically used to index something:
