...
```{r, echo=FALSE}
## http://i2.wp.com/flowingdata.com/wp-content/uploads/2012/08/Bush-cuts.png
knitr::include_graphics("dataviz/img/venezuela-election.png")
```
( Source: 
[Pakistan Today](https://www.pakistantoday.com.pk/2018/05/18/whats-at-stake-in-venezuelan-presidential-vote/) via Diego Mariano)

Here is what the appropriate plot:
