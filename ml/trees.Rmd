...
Note that we can avoid writing our own code by using other Random Forest implementions as described in the __caret__ manual^[http://topepo.github.io/caret/available-models.html].
