...
We use the Random Forest implementation in the Rborist package which is faster than the one in randomForest. [AN: check last words]

Because with Random Forests [AN: note you use singular and plural of Random Forest(s)] the fitting is the slowest part of the procedure rather than the predicting (as with kNN), we will use only 5 fold cross validation.
