...
In this section we will describe how to install the software tools that we recommend as the main productivity tools for data science. To motivate the use of these tools, we will also provide a brief illustrations of how we use them. We will install the following three software tools:
...
```
    You can also open the terminal using by hittin command+spacebar to open _Spotlight Search_ and type _Terminal_ into that search bar, then hit enter.
