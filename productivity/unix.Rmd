...
__Warning: Combining rm with the `*` wildcard can be dangerous. There are combination of these command that will erase you entire filesystem without asking "are you sure?". Make sure you understand how it works before using this wild card with the rm command.__
