...
Much of what we use in this chapter is part of what is called the _Unix shell_. There are actually different shells, but they appear quite similar. The differences are almost unnoticeable.  They are also important, although we do not cover those here. You can see what shell you are using by typing:
