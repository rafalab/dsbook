...
You then need to enter to a path for the Git executable we just installed.
...
You will then want to chose a good descriptive name for the project. In the future, you might have dozens of repos so keep that in mind when choosing a name. Here we will use _homerwork-0_. We recommend you make the repo public. If you want to keep it private, you will have to pay a monthly charge.
