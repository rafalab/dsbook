...
In Section \@ref(git) we introduced Git and GitHub as powerful tools to organize and share your code. We showed how to do this in the command line. RStudio provides a graphical interface that facilitates the use of Git in the context of a data analysis project. We describe how to use this RStudio feature to do this here.
