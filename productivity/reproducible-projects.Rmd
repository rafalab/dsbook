...
In the next section we will use create an RStudio project. In RStudio we go to _File_ and then _New Project..._ and when given the options we pick _Existing Directory_.
