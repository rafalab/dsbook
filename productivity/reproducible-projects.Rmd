...
In Section \@ref(git) we introduced Git and GitHub as powerful tools to orgnanize and share your code. We showed how to do this in the command line. RStudio provides a graphical interface that faciliates the use of Git in the context of a data analysis project. We describe how to use this RStudio feature to do this here.
...
In Section \@ref(prep-project) we demonstrated how to use Unix to prepare for a data science project using an exmaple. Here we continue this example and show how to use RStudio. In  Section \@ref(prep-project) we created the following directories using Unix:
